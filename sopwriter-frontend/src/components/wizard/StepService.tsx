...
export default function StepService({
    ...
    const getServiceDetails = (serviceName: string | null) => {
        if (!serviceName || !currentCategory) return null;
        const svc = currentCategory.services.find(s => s.name === serviceName);
        return svc;
    };

    const currentService = getServiceDetails(wizard.state.service);
    ...
    return (
        <div className="space-y-8 h-full flex flex-col">
            ...
            <div className="relative">
                ...
                >
                    <SelectTrigger className="w-full py-6 text-base font-medium transition-all hover:border-primary/50">
            ...
            <div className="flex justify-between gap-4 pt-4 mt-auto">
                ...
                <Button onClick={onNext} disabled={!canProceed} size="lg" className="px-8 shadow-md">
                    Continue
                </Button>
            </div>
        </div>
