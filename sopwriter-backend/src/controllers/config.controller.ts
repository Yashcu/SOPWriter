    ...
    try {
        ...
        const config = {
            contact: {
                ...
                email: settingsMap['contact_email'] || process.env.DEFAULT_CONTACT_EMAIL || "info@example.com",
                supportEmail: settingsMap['support_email'] || process.env.DEFAULT_SUPPORT_EMAIL || "support@example.com"
            },
            payment: {
