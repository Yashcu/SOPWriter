    ...
    describe('Querying Services', () => {
        beforeEach(async () => {
            await Service.create([
                { code: 'SOP', name: 'Statement of Purpose', category: 'documents', price: 3999, active: true },
                { code: 'LOR', name: 'Letter of Recommendation', category: 'documents', price: 2499, active: true },
                { code: 'RESUME', name: 'Resume Building', category: 'profile', price: 1999, active: true },
                { code: 'INACTIVE', name: 'Inactive Service', category: 'visa', price: 1000, active: false }
            ]);
        });
